<template>
	<div>
		...
		<div style="text-align: left;margin:0 0 20px 50px;">
			...
			<el-select  v-model="devid" style='width:160px;margin-top: 20px;'placeholder='请选择设备名称'>
		...
		<center>
			<el-table :data="list">
				<el-table-column prop="repairid" label="维修ID" width="80"></el-table-column>
				...
				<el-table-column prop="cost" label="维修费用" width="180"></el-table-column>
